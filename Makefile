...
hw3json.o:	hw3json.cpp hw3json.h Record.h
	$(CC) -c $(CFLAGS) hw3json.cpp 
...
main.o: main.cpp Parameter.o hw3json.o
	$(CC) -c $(CFLAGS) main.cpp 
	
run:	main.o Parameter.o Person.o Time.o Thing.o Record.o Location.o hw3json.o
	g++ -std=c++17 main.o Parameter.o Person.o Time.o Thing.o Record.o Location.o hw3json.o -o run $(LDFLAGS)
